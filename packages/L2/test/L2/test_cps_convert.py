...
# #   a file of all the tests for the cps conversion
# #   introducing a bunch of fresh variables so its hard to do comparison checks
# #   need to expose some internals of the algorithm
